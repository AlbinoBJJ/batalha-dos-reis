export class SumoRegras {
    ...
    validarMovimento(origem, destino, grade) {
        var _a;
        ...
        if (pecaOrigem) {
            ...
            for (let l = 0; l < grade.length; l++) {
                for (let c = 0; c < grade[l].length; c++) {
                    if (((_a = grade[l][c].peca) === null || _a === void 0 ? void 0 : _a.tipo) === tipoRival) {
    ...
    executarMovimento(origem, destino, tabuleiro) {
        var _a;
        const peca = (_a = tabuleiro.getCasa(origem.linha, origem.coluna)) === null || _a === void 0 ? void 0 : _a.peca;
    ...
    getMensagemStatusCustomizada() {
        return `⚔️ Alvo: Empurre o Ogro para cima!`;
    }
    testarOposicaoDireta(j, ia) {
    ...
    ehBordaFisica(coord, tab) {
        return coord.linha === 0 || coord.linha === tab.linhas - 1 || coord.coluna === 0 || coord.coluna === tab.colunas - 1;
    }
    encontrarPecaPorTipo(tabuleiro, tipo) {
        var _a;
        const grade = tabuleiro.getGrade();
        for (let l = 0; l < tabuleiro.linhas; l++) {
            for (let c = 0; c < tabuleiro.colunas; c++) {
                if (((_a = grade[l][c].peca) === null || _a === void 0 ? void 0 : _a.tipo) === tipo) {
