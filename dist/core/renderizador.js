export class Renderizador {
    ...
    configurarEstiloTabuleiro(linhas, colunas, temaClasseCSS) {
    ...
    criarElementoCasa(dadosCasa, estadoVisual, onCasaClique, onMoverPeca) {
        ...
        if (dadosCasa.peca) {
            ...
            if (dadosCasa.peca.cor === 'BRANCO' && estadoVisual === 'NORMAL') {
                ...
                pecaDiv.addEventListener('dragstart', (e) => {
                    var _a;
                    pecaDiv.classList.add('movendo');
                    (_a = e.dataTransfer) === null || _a === void 0 ? void 0 : _a.setData('text/plain', JSON.stringify(dadosCasa.coordenada));
                ...
                let clonePeca = null;
                pecaDiv.addEventListener('touchstart', (e) => {
                    touchMoved = false;
                    const touch = e.touches[0];
                    clonePeca = pecaDiv.cloneNode(true);
                ...
                pecaDiv.addEventListener('touchmove', (e) => {
                    touchMoved = true;
                    const touch = e.touches[0];
                    if (clonePeca) {
                        clonePeca.style.transform = `translate3d(${touch.clientX - 25}px, ${touch.clientY - 60}px, 0) scale(1.2)`;
                ...
                pecaDiv.addEventListener('touchend', (e) => {
                    ...
                    const casaAlvo = elementoSobODedo === null || elementoSobODedo === void 0 ? void 0 : elementoSobODedo.closest('.casa');
                    if (!touchMoved) {
        ...
        casaDiv.addEventListener('dragover', (e) => {
            e.preventDefault();
        ...
        casaDiv.addEventListener('drop', (e) => {
            var _a;
            e.preventDefault();
            casaDiv.style.backgroundColor = '';
            if (estadoVisual !== 'NORMAL')
                return;
            const dadosOrigemRaw = (_a = e.dataTransfer) === null || _a === void 0 ? void 0 : _a.getData('text/plain');
            if (dadosOrigemRaw && onMoverPeca) {
                const origem = JSON.parse(dadosOrigemRaw);
                const destino = dadosCasa.coordenada;
    ...
    destacarMovimentosValidos(origem, caminhosValidos) {
        ...
        if (origem) {
            ...
            casaOrigem === null || casaOrigem === void 0 ? void 0 : casaOrigem.classList.add('selecionada');
        }
        caminhosValidos.forEach(coord => {
            ...
            casaValida === null || casaValida === void 0 ? void 0 : casaValida.classList.add('movimento-valido');
        });
    }
